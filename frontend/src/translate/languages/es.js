  ...
  es: {
    translations: {
      ...
      dashboard: {
        pageTitle: "Panel",
        pageSubtitle:
          "Resumen operativo: colas en tiempo real y métricas del período seleccionado.",
        sectionLive: "Tiempo real",
        sectionPeriod: "Métricas del período",
        usersOnline: "Usuarios en línea",
        ticketsWaiting: "Atenciones en espera",
        ...
        filter: {
          heading: "Período y filtros",
          period: "Período",
          custom: "Personalizado",
          invalid: "Define un período o rango de fechas válido.",
        ...
        aura: {
          eyebrow: "Visión general del sistema",
          hubTitle: "Intelligence Hub",
          filterToday: "Hoy",
          filter7d: "7 días",
          filter30d: "30 días",
          filterCustomHint: "Periodo personalizado (use filtros abajo)",
          channelAll: "Todos los canales",
          channelInstagram: "Instagram",
          channelSite: "Sitio web",
          channelTelegram: "Telegram",
          teamAll: "Todos los equipos",
          teamSales: "Ventas",
          teamSupport: "Soporte",
          queueAll: "Todas las colas",
          tagsLiveTitle: "Etiquetas (tiempo real)",
          tagsChartTitle: "Volumen de tickets por etiqueta",
          tagsCardsTitle: "Etiquetas",
          tagsCardsHint: "Conteo en vivo por etiqueta (tickets y contactos cuando aplique).",
          tagsEmpty: "No hay etiquetas creadas.",
          tagsTicketsLabel: "Tickets",
          tagsContactsLabel: "Contactos",
          granularityDaily: "Diario",
          granularityHourly: "Por hora",
          kpiOpenChats: "Conversaciones abiertas",
          kpiNewToday: "Nuevas hoy",
          kpiAvgResponse: "T. respuesta medio",
          kpiSlaMet: "SLA cumplido",
          kpiResolutionRate: "Tasa de resolución",
          kpiAvgResolution: "T. medio resolución",
          kpiCsat: "CSAT",
          kpiConversions: "Conversiones (ventas)",
          trendHighLoad: "Carga alta",
          trendVsYesterday: "12% vs ayer",
          trendExcellent: "Excelente",
          trendGoalMet: "Meta cumplida",
          trendVsYesterday3: "3% vs ayer",
          trendStable: "Estable",
          trendHighSat: "Alta satisfacción",
          trendClosedDeals: "24 cerradas",
          chartVolumeTitle: "Volumen de conversaciones vs resueltos",
          chartWaitTitle: "Evolución tiempo de respuesta",
          chartOriginTitle: "Origen por canal",
          chartStatusTitle: "Estado de tickets abiertos",
          legendNewContacts: "Nuevos contactos",
          legendResolved: "Resueltos",
          legendWaitMinutes: "T. espera cliente (min)",
          statusOpen: "Abierto",
          statusInProgress: "En curso",
          statusAwaiting: "Esperando cliente",
          statusResolved: "Resuelto",
          statusClosed: "Cerrado",
          panelRealtimeTitle: "Operación en tiempo real",
          rtCurrentQueue: "Cola actual",
          rtWaitingSuffix: "en espera",
          rtAvgWait: "Espera media",
          rtAgentsOnline: "Agentes en línea",
          rtAvailableSuffix: "disponibles",
          rtBusyPause: "Ocupados / pausa",
          rtAgentsOnOff: "Agentes (on / off)",
          alertsHeading: "Alertas (SLA)",
          alertSlaBreach: "5 conversaciones fuera de SLA",
          alertView: "Ver",
          alertQueueSales: "Cola Ventas por encima de lo normal",
          alertOk: "OK",
          panelQueuesTitle: "Colas y departamentos",
          panelAgentsTitle: "Rendimiento de agentes",
          thQueue: "Cola",
          thWaiting: "En espera",
          thAgents: "Agentes",
          thAgent: "Agente",
          ...
          badgePause: "Pausa",
          badgeOffline: "Fuera de línea",
          queueSales: "Ventas",
          queueSupport: "Soporte",
          queueFinance: "Finanzas",
          panelReasonsTitle: "Motivos de cierre",
          panelFollowupTitle: "Seguimiento y automatizaciones",
          reasonResolved: "Resuelto",
          reasonSale: "Venta",
          reasonQuote: "Presupuesto",
          reasonNoReply: "Sin resp.",
          reasonSpam: "Spam",
          followAwaiting: "Esperando cliente",
          followAwaitingVal: "18 activos",
          followPostSale: "Posventa programada",
          followPostSaleVal: "6 hoy",
          followQuote: "Presupuesto enviado",
          followQuoteVal: "11 pendientes",
          followAi: "Recordatorios (IA)",
          followAiVal: "9 enviados",
          aiTitle: "Insights de Aura IA",
          aiBody:
            "Los clientes con respuesta en hasta 2 minutos convierten un 38% más. Refuerza Ventas entre 14h y 16h por el pico histórico de demanda.",
        },
        extras: {
          mockBadge: "Datos de demostración",
          sectionTitle: "Insights, SLA y distribución",
          appearance: "Apariencia",
          themeLight: "Claro",
          themeDark: "Oscuro",
          insightTitle: "Resumen operativo",
          insightBody:
            "Picos entre las 10 y 11 y fuerte participación en WhatsApp. Cuando exista API, estas tarjetas mostrarán tus métricas reales.",
          slaTitle: "SLA y cumplimiento",
          slaTarget: "objetivo",
          slaFirstResponse: "Primera respuesta",
          slaResolution: "Resolución a tiempo",
          slaReopen: "Reaperturas evitadas",
          channelsTitle: "Volumen por canal",
          channelWhatsapp: "WhatsApp",
          channelInstagram: "Instagram",
          channelMessenger: "Messenger",
          channelWebchat: "Webchat",
          channelEmail: "Correo",
          csatTitle: "Satisfacción (0–5) por día",
          demandPeaksTitle: "Picos de demanda por hora",
          responseMixTitle: "Origen de respuestas",
          mixHuman: "Agente humano",
          mixBot: "Bot / automatización",
          mixTransferred: "Transferido",
          geoTitle: "Geolocalización de contactos",
          geoSubtitle:
            "Mapa estilizado con puntos por región (datos de prueba). Luego conecta API o IP/geo.",
          geoSubtitleDdd:
            "DDD extraído de los números (55 + DDD o 10/11 dígitos), agrupado por región de Brasil.",
          geoCenterLabel: "Agregado por área metropolitana",
          geoCenterLabelReal:
            "{{count}} contactos con DDD válido · distribución por región",
          geoDddByRegion: "Todos los DDD por región",
          geoRegionNorte: "Norte",
          geoRegionNordeste: "Nordeste",
          geoRegionCentroOeste: "Centro-Oeste",
          geoRegionSudeste: "Sudeste",
          geoRegionSul: "Sur",
          geoRegionUnknown: "DDD no mapeado",
          weekdayMon: "Lun",
          weekdayTue: "Mar",
          weekdayWed: "Mié",
          weekdayThu: "Jue",
      ...
      contactDrawer: {
        ...
        emptyDetails: "No hay campos adicionales para este contacto.",
