  ...
  en: {
    translations: {
      ...
      dashboard: {
        pageTitle: "Dashboard",
        pageSubtitle:
          "Operational overview: live queues and metrics for the selected period.",
        sectionLive: "Live",
        sectionPeriod: "Period metrics",
        ...
        filter: {
          ...
          period: "Period",
          custom: "Custom",
          invalid: "Choose a valid period or date range.",
        ...
        aura: {
          ...
          filter7d: "7 days",
          filter30d: "30 days",
          filterCustomHint: "Custom period (use filters below)",
          ...
          teamSupport: "Support",
          queueAll: "All queues",
          tagsLiveTitle: "Tags (live)",
          tagsChartTitle: "Ticket volume by tag",
          tagsCardsTitle: "Tags",
          tagsCardsHint: "Live counts per tag (tickets and contacts when available).",
          tagsEmpty: "No tags created yet.",
          tagsTicketsLabel: "Tickets",
          tagsContactsLabel: "Contacts",
          granularityDaily: "Daily",
          granularityHourly: "Hourly",
          kpiOpenChats: "Open conversations",
          ...
          kpiCsat: "CSAT",
          kpiConversions: "Conversions (sales)",
          trendHighLoad: "High load",
          trendVsYesterday: "12% vs yesterday",
          trendExcellent: "Excellent",
          trendGoalMet: "Goal met",
          trendVsYesterday3: "3% vs yesterday",
          trendStable: "Stable",
          trendHighSat: "High satisfaction",
          trendClosedDeals: "24 closed",
          chartVolumeTitle: "Conversation volume vs resolved",
          chartWaitTitle: "Response time trend",
          chartOriginTitle: "Traffic by channel",
          chartStatusTitle: "Open ticket status",
          legendNewContacts: "New contacts",
          legendResolved: "Resolved",
          legendWaitMinutes: "Avg. wait (min)",
          statusOpen: "Open",
          statusInProgress: "In progress",
          statusAwaiting: "Awaiting customer",
          statusResolved: "Resolved",
          statusClosed: "Closed",
          panelRealtimeTitle: "Live operations",
          rtCurrentQueue: "Current queue",
          rtWaitingSuffix: "waiting",
          rtAvgWait: "Avg. wait",
          rtAgentsOnline: "Agents online",
          rtAvailableSuffix: "available",
          rtBusyPause: "Busy / pause",
          rtAgentsOnOff: "Agents (on / off)",
          alertsHeading: "SLA alerts",
          alertSlaBreach: "5 conversations breaching SLA",
          alertView: "View",
          alertQueueSales: "Sales queue above normal",
          alertOk: "OK",
          panelQueuesTitle: "Queues & departments",
          panelAgentsTitle: "Agent performance",
          thQueue: "Queue",
          thWaiting: "Waiting",
          thAgents: "Agents",
          thAgent: "Agent",
          ...
          panelReasonsTitle: "Close reasons",
          panelFollowupTitle: "Follow-up & automations",
          reasonResolved: "Resolved",
          reasonSale: "Sale",
          reasonQuote: "Quote",
          reasonNoReply: "No reply",
          reasonSpam: "Spam",
          followAwaiting: "Awaiting customer",
          followAwaitingVal: "18 active",
          followPostSale: "Post-sale scheduled",
          followPostSaleVal: "6 today",
          followQuote: "Quote sent",
          followQuoteVal: "11 pending",
          followAi: "AI reminders",
          followAiVal: "9 sent",
          aiTitle: "Aura AI insights",
          aiBody:
            "Customers who get a reply within 2 minutes convert 38% more. Consider reinforcing Sales between 2–4 PM due to historical demand peaks.",
        },
        extras: {
          mockBadge: "Demo data",
          sectionTitle: "Insights, SLA & distribution",
          appearance: "Appearance",
          themeLight: "Light",
          themeDark: "Dark",
          insightTitle: "Operational snapshot",
          insightBody:
            "Peak demand between 10–11 and strong WhatsApp share. When the API is ready, these cards will reflect your real metrics.",
          slaTitle: "SLA compliance",
          slaTarget: "target",
          slaFirstResponse: "First response",
          slaResolution: "On-time resolution",
          slaReopen: "Reopen prevention",
          channelsTitle: "Volume by channel",
          channelWhatsapp: "WhatsApp",
          channelInstagram: "Instagram",
          channelMessenger: "Messenger",
          channelWebchat: "Webchat",
          channelEmail: "Email",
          csatTitle: "Satisfaction (0–5) by day",
          demandPeaksTitle: "Hourly demand peaks",
          responseMixTitle: "Response mix",
          mixHuman: "Human agent",
          mixBot: "Bot / automation",
          mixTransferred: "Transferred",
          geoTitle: "Contact geolocation",
          geoSubtitle:
            "Stylized map with regional pins (mock data). Wire to API or IP/geo later.",
          geoSubtitleDdd:
            "Area code (DDD) parsed from contact numbers (55 + DDD or 10/11 digits), grouped by Brazilian region.",
          geoCenterLabel: "Aggregated by metro area",
          geoCenterLabelReal:
            "{{count}} contacts with valid DDD · distribution by region",
          geoDddByRegion: "All DDDs by region",
          geoRegionNorte: "North",
          geoRegionNordeste: "Northeast",
          geoRegionCentroOeste: "Central-West",
          geoRegionSudeste: "Southeast",
          geoRegionSul: "South",
          geoRegionUnknown: "Unmapped DDD",
          weekdayMon: "Mon",
          weekdayTue: "Tue",
          weekdayWed: "Wed",
          weekdayThu: "Thu",
      ...
      messagesInput: {
        ...
        composer: {
          ...
          schedule: "Schedule",
          placeholderNote:
            "Write an internal note (not sent to the contact).",
          placeholderQuick:
            "Shift + Enter for new line. Type / for canned responses.",
          placeholderSchedule:
            "Pick date and time above. Scheduled send is coming soon.",
          hint: "Shift + Enter for new line. Use / for quick replies.",
          noteSaved: "Note saved on the ticket.",
          scheduleSoon: "Scheduled messaging is not available yet.",
          send: "Send",
        },
      },
      message: {
      ...
      contactDrawer: {
        ...
        emptyDetails: "No additional fields for this contact.",
