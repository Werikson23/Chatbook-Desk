  ...
  pt: {
    translations: {
      ...
      dashboard: {
        pageTitle: "Painel",
        pageSubtitle:
          "Visão geral da operação: filas em tempo real e métricas do período selecionado.",
        sectionLive: "Tempo real",
        sectionPeriod: "Métricas do período",
        ...
        filter: {
          ...
          invalid: "Defina um período ou intervalo de datas válido.",
          closeReason: "Motivo de encerramento",
          closeReasonAll: "Todos",
        ...
        aura: {
          ...
          filter7d: "7 dias",
          filter30d: "30 dias",
          filterCustomHint: "Período personalizado (use filtros abaixo)",
          channelAll: "Todos os canais",
          channelInstagram: "Instagram",
          channelSite: "Site",
          channelTelegram: "Telegram",
          teamAll: "Todas as equipes",
          teamSales: "Vendas",
          teamSupport: "Suporte",
          queueAll: "Todas as filas",
          tagsLiveTitle: "Etiquetas (tempo real)",
          tagsChartTitle: "Volume de tickets por etiqueta",
          tagsCardsTitle: "Etiquetas",
          tagsCardsHint: "Contagem ao vivo por etiqueta (tickets e contactos quando disponível).",
          tagsEmpty: "Nenhuma etiqueta cadastrada.",
          tagsTicketsLabel: "Tickets",
          tagsContactsLabel: "Contactos",
          granularityDaily: "Diário",
          granularityHourly: "Horário",
          kpiOpenChats: "Conversas abertas",
          kpiNewToday: "Novas hoje",
          kpiAvgResponse: "T. resposta médio",
          kpiSlaMet: "SLA cumprido",
          kpiResolutionRate: "Taxa resolução",
          kpiAvgResolution: "T. médio resolução",
          kpiCsat: "CSAT",
          kpiConversions: "Conversões (vendas)",
          trendHighLoad: "Carga alta",
          trendVsYesterday: "12% vs ontem",
          trendExcellent: "Excelente",
          trendGoalMet: "Meta batida",
          trendVsYesterday3: "3% vs ontem",
          trendStable: "Estável",
          trendHighSat: "Satisfação alta",
          trendClosedDeals: "24 fechadas",
          chartVolumeTitle: "Volume de conversas x resolvidos",
          chartWaitTitle: "Evolução tempo de resposta",
          chartOriginTitle: "Origem por canal",
          chartStatusTitle: "Status dos tickets abertos",
          legendNewContacts: "Novos contatos",
          legendResolved: "Resolvidos",
          legendWaitMinutes: "T. espera cliente (min)",
          statusOpen: "Aberto",
          statusInProgress: "Em andamento",
          statusAwaiting: "Aguardando cliente",
          statusResolved: "Resolvido",
          statusClosed: "Fechado",
          panelRealtimeTitle: "Operação em tempo real",
          rtCurrentQueue: "Fila atual",
          rtWaitingSuffix: "aguardando",
          rtAvgWait: "Espera média",
          rtAgentsOnline: "Agentes online",
          rtAvailableSuffix: "disponíveis",
          rtBusyPause: "Ocupados / pausa",
          rtAgentsOnOff: "Agentes (on / off)",
          alertsHeading: "Alertas (SLA)",
          alertSlaBreach: "5 conversas estourando SLA",
          alertView: "Ver",
          alertQueueSales: "Fila Vendas acima do normal",
          alertOk: "OK",
          panelQueuesTitle: "Filas e departamentos",
          panelAgentsTitle: "Performance de agentes",
          thQueue: "Fila",
          thWaiting: "Aguardando",
          thAgents: "Agentes",
          thAgent: "Agente",
          thTickets: "Atend.",
          thStatus: "Status",
          ...
          queueSales: "Vendas",
          queueSupport: "Suporte",
          queueFinance: "Financeiro",
          panelReasonsTitle: "Motivos de fechamento",
          panelFollowupTitle: "Follow-up e automações",
          reasonResolved: "Resolvido",
          reasonSale: "Venda",
          reasonQuote: "Orçamento",
          reasonNoReply: "Sem resp.",
          reasonSpam: "Spam",
          followAwaiting: "Aguardando cliente",
          followAwaitingVal: "18 ativos",
          followPostSale: "Pós-venda agendado",
          followPostSaleVal: "6 hoje",
          followQuote: "Orçamento enviado",
          followQuoteVal: "11 pendentes",
          followAi: "Lembretes (IA)",
          followAiVal: "9 disparados",
          aiTitle: "Insights da Aura IA",
          aiBody:
            "Clientes que recebem resposta em até 2 minutos convertem 38% mais. Considere reforçar a equipe de vendas entre 14h e 16h devido ao pico histórico de demanda.",
        },
        extras: {
          mockBadge: "Dados de demonstração",
          sectionTitle: "Insights, SLA e distribuição",
          appearance: "Aparência",
          themeLight: "Claro",
          themeDark: "Escuro",
          insightTitle: "Resumo da operação",
          insightBody:
            "Picos entre 10h e 11h e forte participação no WhatsApp. Quando o back-end expuser estes indicadores, estes cartões passam a refletir os teus dados reais.",
          slaTitle: "SLA e cumprimento",
          slaTarget: "meta",
          slaFirstResponse: "Primeira resposta",
          slaResolution: "Resolução no prazo",
          slaReopen: "Reaberturas evitadas",
          channelsTitle: "Volume por canal",
          channelWhatsapp: "WhatsApp",
          channelInstagram: "Instagram",
          channelMessenger: "Messenger",
          channelWebchat: "Webchat",
          channelEmail: "E-mail",
          csatTitle: "Satisfação (0–5) por dia",
          demandPeaksTitle: "Picos de demanda por hora",
          responseMixTitle: "Origem das respostas",
          mixHuman: "Agente humano",
          mixBot: "Bot / automação",
          mixTransferred: "Transferido",
          geoTitle: "Geolocalização dos contactos",
          geoSubtitle:
            "Mapa estilizado com pontos por região (dados mock). Integra depois com API ou IP/geo.",
          geoSubtitleDdd:
            "DDD extraído dos números dos contactos (55 + DDD ou 10/11 dígitos), agregado por região do Brasil.",
          geoCenterLabel: "Agregação por região metropolitana",
          geoCenterLabelReal:
            "{{count}} contactos com DDD válido · distribuição por região",
          geoDddByRegion: "Todos os DDD por região",
          geoRegionNorte: "Norte",
          geoRegionNordeste: "Nordeste",
          geoRegionCentroOeste: "Centro-Oeste",
          geoRegionSudeste: "Sudeste",
          geoRegionSul: "Sul",
          geoRegionUnknown: "DDD não mapeado",
          weekdayMon: "Seg",
          weekdayTue: "Ter",
          weekdayWed: "Qua",
          weekdayThu: "Qui",
      ...
      contacts: {
        ...
        toasts: {
          ...
          imported: "Importação de CSV iniciada com sucesso.",
        },
      ...
      settings: {
        ...
        title: "Configurações",
        superadminSaaSTitle: "Superadmin (SaaS)",
      ...
      messagesInput: {
        ...
        composer: {
          ...
          schedule: "Programado",
          placeholderNote:
            "Escreva uma nota interna (não é enviada ao cliente).",
          placeholderQuick:
            "Shift + Enter nova linha. Digite / para respostas prontas.",
          placeholderSchedule:
            "Escolha data e hora acima. O agendamento de envio virá em breve.",
          hint: "Shift + Enter para nova linha. Use / para resposta rápida.",
          noteSaved: "Nota salva no atendimento.",
          scheduleSoon:
            "Agendamento de mensagens será suportado em breve nesta versão.",
          send: "Enviar",
        },
      },
      message: {
      ...
      contactDrawer: {
        ...
        emptyDetails: "Sem campos adicionais neste contato.",
